...
//            "org.eclipse.team.ccvs.ui.RepositoriesView"), //$NON-NLS-1$
     ...
     * @param  ui       - Driver for UI generated input
     * @param  view     - View to open.
     * @param  timeout  - Number of milliseconds to wait for the view to open before
     *                  failing the test. The default timeout is 30 seconds
     */
    public void openView(IUIContext ui, IView type, long timeout);
