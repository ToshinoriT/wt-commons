...
public class Snippet004VerifyTreeContents extends UITestCaseSWT {
	...
	private void verifySourceAndClassFilesExist()
	...
	private void deleteClass() throws WidgetSearchException,
			WaitTimedOutException {
		IUIContext ui = getUI();
		ui.contextClick(new TreeItemLocator(getProjectName() + "/src/" + getJavaClassName() + ".java").in(view(
			"Navigator")), "Delete");
